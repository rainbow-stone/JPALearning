...
public class PodamService {
  ...
  public PodamFactory createFactory() {
    ...
    final IntTypeManufacturerImpl intManufacturer =
        new IntTypeManufacturerImpl() {
          @Override
    ...
    final LongTypeManufacturerImpl longManufacturer =
        new LongTypeManufacturerImpl() {
          @Override
    ...
    final StringTypeManufacturerImpl stringManufacturer =
        new StringTypeManufacturerImpl() {
          @Override
    ...
    final TypeManufacturer<BigDecimal> doubleTypeManufacturer =
        (strategy, attributeMetadata, genericTypesArgumentsMap) ->
            BigDecimal.valueOf(PodamUtils.getDoubleInRange(0, 10000000D))
    ...
    podamFactory
        .getStrategy()
        .addOrReplaceTypeManufacturer(BigDecimal.class, doubleTypeManufacturer);
