    ...
    return (root, query, cb) -> {
      ...
      if (policy != null) {
        ...
        if (policy.getIdType() != null && policy.getIdCode() != null) {
          ...
          subQuery
              .select(customerRoot.get("customerId"))
              .where(
                  cb.equal(customerRoot.get("idType"), policy.getIdType()),
